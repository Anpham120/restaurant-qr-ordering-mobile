...
export const EN_COPY: Record<string, string> = {
  ...
  "Không cập nhật được ghi chú món.": "The item note could not be updated.",
  "Ghi chú cho bếp": "Kitchen note",
  "Ghi chú cho {item}": "Note for {item}",
  "Ví dụ: ít cay, không hành": "Example: less spicy, no scallions",
