...
export type AuditLogEntry = { id: string; occurredAt: string; actorUserId: string | null; actorName: string | null; actorRole: string; action: string; subjectType: string; subjectId: string; tableCode: string | null; amount: number | null; reason: string | null; beforeData: unknown | null; afterData: unknown | null };
export type AuditLogListResponse = { items: AuditLogEntry[]; total: number };
export type SelfLoyaltyAccrualReport = { month: string; actorUserId: string | null; actorName: string | null; occurrenceCount: number; totalAmount: number; totalPoints: number };
