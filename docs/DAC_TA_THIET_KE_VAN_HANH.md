...
| 3 | Vùng chạm | `.ops-btn` ≈ **34px** cao, `.ops-btn--sm` ≈ **26px**, dùng **28 lần** | Chuẩn cảm ứng là 44×44. `min-height: 44px` chỉ tồn tại cho nút thẻ bếp và **chỉ dưới `max-width: 768px`** |
...
**`ops-btn--sm` bị xoá.** 28 chỗ đang dùng nó chuyển sang cỡ chuẩn. Nếu một khu vực chật tới mức
...
| Đơn vị chính | **Thẻ món**, không phải thẻ đơn. Bếp làm món, không làm đơn |
